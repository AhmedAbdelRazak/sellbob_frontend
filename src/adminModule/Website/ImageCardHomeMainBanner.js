								...
								bannerData.images.map((image, index) => (
									...
									>
										...
										<div className='input-fields'>
											...
											<input
												type='text'
												placeholder='Title Indian'
												value={image.titleIndian || ""}
												onChange={(e) =>
													handleFieldChange(
														index,
														"titleIndian",
											...
											<input
												type='text'
												placeholder='Subtitle Indian'
												value={image.subtitleIndian || ""}
												onChange={(e) =>
													handleFieldChange(
														index,
														"subtitleIndian",
											...
											<input
												type='text'
												placeholder='Button Title Indian'
												value={image.buttonTitleIndian || ""}
												onChange={(e) =>
													handleFieldChange(
														index,
														"buttonTitleIndian",
